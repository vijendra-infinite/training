...
values
    ('vijendra', '1998-05-15', 26),
    ('aadi', '1999-09-20', 25),
    ('utkarsh', '2004-03-10', 22);
...
insert into EMP (Empno, Ename, Job, HireDate, Mgr_id, Sal, Comm, DeptNo)
values
    (9999, 'Don' , 'ANALYST' , '2022-03-15', 7968, 4000,100, 20), 
    (8888, 'Lucy' , 'CLERK' , '2023-05-20', 7902, 2000,1000, 10),   
    (7777, 'Pritam' , 'MANAGER' , '2024-01-10', 7839, 5000,130, 30); 
	 select * from EMP
...
select * from Employee where Empno = 1;  --IT WILL insert the data into the temporary table so that we can access again

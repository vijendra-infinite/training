...
namespace CC9_MVC.Models
{
    ...
    public partial class NorthWindEntities : DbContext
    {
        ...
        [DbFunction("NorthWindEntities", "fn_GetEmployeesbycountry")]
        public virtual IQueryable<fn_GetEmployeesbycountry_Result> fn_GetEmployeesbycountry(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("country", country) :
                new ObjectParameter("country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_GetEmployeesbycountry_Result>("[NorthWindEntities].[fn_GetEmployeesbycountry](@country)", countryParameter);
        }
